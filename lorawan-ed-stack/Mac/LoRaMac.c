...
static rt_uint8_t rt_loramac_thread_stack[2048];
#endif
...
#ifdef LORAWAN_MAC_COMMAND_DEVICE_TIME_ENABLE    
...
#ifdef LORAWAN_ED_STACK_USING_ON_RTOS_RT_THREAD
/*!
 * \brief This function handles callback events for Tx Done event
 */
static void ProcessRadioTxDone( void );

/*!
 * \brief This function handles callback events for Tx Timeout event
 */
static void ProcessRadioTxTimeout( void ); 

/*!
 * \brief This function handles callback events for Rx Done event
 */
static void ProcessRadioRxDone( void );

/*!
 * \brief This function handles callback events for Rx Timeout event
 */
static void ProcessRadioRxTimeout( void );

/*!
 * \brief This function handles callback events for Rx Error event
 */
static void ProcessRadioRxError( void );

#endif // end of LORAWAN_ED_STACK_USING_ON_RTOS_RT_THREAD
...
#ifdef LORAWAN_ED_STACK_DEBUG_MAC_RX_WINDOW_TIMESTAMP
/*!
 * Structure used to store the radio Tx \Rx timestamp
 */
struct
{
    TimerTime_t rx1_timestamp;
    TimerTime_t rx2_timestamp;
}timestamp_info_dbg;
#endif
 ...
 * MAC mtype strings
 */
const char *mtype_strings[] = 
{ 
    "Join Request",                  // FRAME_TYPE_JOIN_REQ
    "Join Accept",                   // FRAME_TYPE_JOIN_ACCEPT
    "UnConfirm Up",                  // FRAME_TYPE_DATA_UNCONFIRMED_UP
    "UnConfirm Down",                // FRAME_TYPE_DATA_UNCONFIRMED_DOWN
    "Confirm Up",                    // FRAME_TYPE_DATA_CONFIRMED_UP
    "Confirm Down",                  // FRAME_TYPE_DATA_CONFIRMED_DOWN
    "Rejoin Request",                // RFU
    "Proprietary",                   // FRAME_TYPE_PROPRIETARY
};
    
/*!
 * MAC Cryto strings
 */
const char* loramac_crypto_strings[] =
{
    "MAC CRYPTO SUCCESS",                       // LORAMAC_CRYPTO_SUCCESS
    "MAC CRYPTO MIC Fail",                      // LORAMAC_CRYPTO_FAIL_MIC
    "MAC CRYPTO DevAddr Dismatch",              // LORAMAC_CRYPTO_FAIL_ADDRESS
    "MAC CRYPTO JOIN_NONCE Fail",               // LORAMAC_CRYPTO_FAIL_JOIN_NONCE
    "MAC CRYPTO RJCOUNT0_OVERFLOW Fail",        // LORAMAC_CRYPTO_FAIL_RJCOUNT0_OVERFLOW
    "MAC CRYPTO FCNT_ID Fail",                  // LORAMAC_CRYPTO_FAIL_FCNT_ID
    "MAC CRYPTO FCNT SMALLER",                  // LORAMAC_CRYPTO_FAIL_FCNT_SMALLER
    "MAC CRYPTO FCNT DUPLICATED",               // LORAMAC_CRYPTO_FAIL_FCNT_DUPLICATED
    "MAC CRYPTO MAX_GAP_FCNT",                  // LORAMAC_CRYPTO_FAIL_MAX_GAP_FCNT
    "MAC CRYPTO Parameter not allowed ",        // LORAMAC_CRYPTO_FAIL_PARAM
    "MAC CRYPTO Null pointer",                  // LORAMAC_CRYPTO_ERROR_NPE
    "MAC CRYPTO KEY_ID INVALID",                // LORAMAC_CRYPTO_ERROR_INVALID_KEY_ID
    "MAC CRYPTO ADDR_ID INVALID",               // LORAMAC_CRYPTO_ERROR_INVALID_ADDR_ID
    "MAC CRYPTO LoRaWAN version Invalid ",      // LORAMAC_CRYPTO_ERROR_INVALID_VERSION
    "MAC CRYPTO Incompatible buffer size",      // LORAMAC_CRYPTO_ERROR_BUF_SIZE
    "MAC CRYPTO SECURE ELEMENT FUNC",           // LORAMAC_CRYPTO_ERROR_SECURE_ELEMENT_FUNC
    "MAC CRYPTO PARSER ERROR",                  // LORAMAC_CRYPTO_ERROR_PARSER
    "MAC CRYPTO SERIALIZER ERROR",              // LORAMAC_CRYPTO_ERROR_SERIALIZER
    "MAC CRYPTO ERROR_RJCOUNT1 OVERFLOW",       // LORAMAC_CRYPTO_ERROR_RJCOUNT1_OVERFLOW
    "MAC CRYPTO ERROR"                          // LORAMAC_CRYPTO_ERROR
};

/*!
 * MAC status strings
 */
const char* loramac_status_strings[] =
{    
    "MAC OK",                            // LORAMAC_STATUS_OK
    "MAC Busy",                          // LORAMAC_STATUS_BUSY
    "MAC Service unknown",               // LORAMAC_STATUS_SERVICE_UNKNOWN
    "MAC Parameter invalid",             // LORAMAC_STATUS_PARAMETER_INVALID
    "MAC Frequency invalid",             // LORAMAC_STATUS_FREQUENCY_INVALID
    "MAC Datarate invalid",              // LORAMAC_STATUS_DATARATE_INVALID
    "MAC Frequency or datarate invalid", // LORAMAC_STATUS_FREQ_AND_DR_INVALID
    "MAC No network joined",             // LORAMAC_STATUS_NO_NETWORK_JOINED
    "MAC Length error",                  // LORAMAC_STATUS_LENGTH_ERROR
    "MAC Region not supported",          // LORAMAC_STATUS_REGION_NOT_SUPPORTED
    "MAC Skipped APP data",              // LORAMAC_STATUS_SKIPPED_APP_DATA
    "MAC Duty-cycle restricted",         // LORAMAC_STATUS_DUTYCYCLE_RESTRICTED
    "MAC No channel found",              // LORAMAC_STATUS_NO_CHANNEL_FOUND
    "MAC No free channel found",         // LORAMAC_STATUS_NO_FREE_CHANNEL_FOUND
    "MAC Busy beacon reserved time",     // LORAMAC_STATUS_BUSY_BEACON_RESERVED_TIME
    "MAC Busy ping-slot window time",    // LORAMAC_STATUS_BUSY_PING_SLOT_WINDOW_TIME
    "MAC Busy uplink collision",         // LORAMAC_STATUS_BUSY_UPLINK_COLLISION
    "MAC Crypto error",                  // LORAMAC_STATUS_CRYPTO_ERROR
    "MAC FCnt handler error",            // LORAMAC_STATUS_FCNT_HANDLER_ERROR
    "MAC command error",                 // LORAMAC_STATUS_MAC_COMMAD_ERROR
    "MAC ClassB error",                  // LORAMAC_STATUS_CLASS_B_ERROR
    "MAC Confirm queue error",           // LORAMAC_STATUS_CONFIRM_QUEUE_ERROR
    "MAC Multicast group undefined",     // LORAMAC_STATUS_MC_GROUP_UNDEFINED
    "MAC Unknown error",                 // LORAMAC_STATUS_ERROR
};

const char* loramac_mlme_req_strings[] =
{
    "MLME JOIN",
    "MLME REJOIN0",
    "MLME REJOIN1",
    ...
    "MLME TXCW",
    "MLME TXCW1",
    "MLME SCHEDULE UPLINK",
    "MLME NVM CTXS UPDATE",
    "MLME DERIVE MC-KE KEY",
    "MLME DERIVE MC-KEY PAIR",
    "MLME DEVICE TIME",
    "MLME BEACON",
    "MLME BEACON ACQUISITION",
    "MLME PING SLOT INFO",
    "MLME BEACON TIMING",
    "MLME BEACON LOST"
};
...
static void OnRadioTxDone( void )
{
    ...
    //LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"PHY TXDone\r");
#endif
}
...
#ifdef LORAWAN_ED_STACK_USING_DEVICE_TYPE_CLASS_C
    else
    {
...
static void ProcessRadioRxDone( void )
{
    ...
    {
#ifdef USE_LORA_GATEWAY_1CH_MODE
        case FRAME_TYPE_JOIN_REQ:

            // check white list

            // send join-accept
            LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"[UP]->FRAME_TYPE_JOIN_REQ: Status = %d",macCryptoStatus);
            break;
        case FRAME_TYPE_DATA_CONFIRMED_UP:
            LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"[UP]->FRAME_TYPE_DATA_CONFIRMED_UP: Status = %d",macCryptoStatus);
            
        case FRAME_TYPE_DATA_UNCONFIRMED_UP:
            LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"[UP]->FRAME_TYPE_DATA_UNCONFIRMED_UP: Status = %d",macCryptoStatus);
            break;
#endif
        case FRAME_TYPE_JOIN_ACCEPT:
            ...
            LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"[DN-JOIN_ACCEPT]: %s(%d)",loramac_crypto_strings[macCryptoStatus], macCryptoStatus);
            ...
            if( LORAMAC_CRYPTO_SUCCESS == macCryptoStatus )
            {
                ...
                LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"Join Accept Payload:" );
                LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"  NetID[3B]:0x%06X,\r\n  DevAddr[4B]:0x%08X,\r\n  RX1DrOffset:%d,\r\n  RX2Datarate:%d,\r\n  RX1Delay:%d,\r\n  Ver.Minor:%d\r\n",
                                                            MacCtx.NvmCtx->NetID,
                                                            MacCtx.NvmCtx->DevAddr,
                                                            MacCtx.NvmCtx->MacParams.Rx1DrOffset,
                                                            MacCtx.NvmCtx->MacParams.Rx2Channel.Datarate,
                                                            MacCtx.NvmCtx->MacParams.ReceiveDelay1,
                                                            MacCtx.NvmCtx->Version.Fields.Minor);
            }
            else
            {
                // MLME handling
        ...
        case FRAME_TYPE_DATA_UNCONFIRMED_DOWN:
            ...
            MacCtx.MacFlags.Bits.McpsInd = 1;
            LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"[DN DATA INFO]: Status = %d",MacCtx.McpsIndication.Status,fType);
            break;
...
#ifdef LORAWAN_ED_STACK_DEBUG_MAC
        if(MacCtx.McpsConfirm.McpsRequest == MCPS_CONFIRMED)
        {
            LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"[ReTX INFO]: AckTimeoutRetriesCounter = %d / %d",MacCtx.AckTimeoutRetriesCounter, MacCtx.AckTimeoutRetries);
        }
        else
        {
            LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"[ReTX INFO]: ChannelsNbTransCounter = %d / %d",MacCtx.ChannelsNbTransCounter, MacCtx.NvmCtx->MacParams.ChannelsNbTrans);
        }
#endif
    }
}
...
#ifdef LORAWAN_ED_STACK_DEBUG_MAC_RX_WINDOW_TIMESTAMP
    timestamp_info_dbg.rx1_timestamp = TimerGetCurrentTime( );
    LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"[RX1 TIME INFO]: Td=%d(offset=%d),Tm=%d ms",MacCtx.RxWindow1Delay,
                                                                                MacCtx.RxWindow1Config.WindowOffset, 
                                                                                ( timestamp_info_dbg.rx1_timestamp - TxDoneParams.CurTime ));
#endif
}
...
#ifdef LORAWAN_ED_STACK_DEBUG_MAC_RX_WINDOW_TIMESTAMP
    timestamp_info_dbg.rx2_timestamp = TimerGetCurrentTime( );
    LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"[RX2 TIME INFO]: Td=%d(offset=%d),Tm=%d ms",MacCtx.RxWindow2Delay,
                                                                                                           MacCtx.RxWindow2Config.WindowOffset,
                                                                                                           ( timestamp_info_dbg.rx2_timestamp - TxDoneParams.CurTime ) );
#endif
}
...
#ifdef LORAWAN_ED_STACK_DEBUG_MAC_COMMAND_CONFIG
    if(commandsSize)
    {
        LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC_COMMAND, DBG_LVL,"[Mac Command Payload(%d)]:",commandsSize);
        for( uint8_t i = 0; i < commandsSize; i++ )
        {
            LORAWAN_ED_DEBUG_LOG_RAW(LORAWAN_ED_STACK_DEBUG_MAC_COMMAND, " %02X",payload[macIndex + i]);
        }
        LORAWAN_ED_DEBUG_LOG_RAW(LORAWAN_ED_STACK_DEBUG_MAC_COMMAND, "\r\n");
    }
#endif
...
LoRaMacStatus_t PrepareFrame( LoRaMacHeader_t* macHdr, LoRaMacFrameCtrl_t* fCtrl, uint8_t fPort, void* fBuffer, uint16_t fBufferSize )
{
    ...
    LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"[UP DATA INFO]:%s,UpLinkCounter:%d,Nbtrials:%d/%d,Fport:%d,macSize:%d",
                                                                 mtype_strings[macHdr->Bits.MType],
                                                                 MacCtx.McpsConfirm.UpLinkCounter,
                                                                 MacCtx.NvmCtx->MacParams.ChannelsNbTrans,
                                                                 MacCtx.TxMsg.Message.Data.FPort,
                                                                 macCmdsSize);
    return LORAMAC_STATUS_OK;
}
...
static void loramac_process_notify(void)
{
    rt_event_send(&loramac_event, EV_LORAMAC_PROCESS_NOTIFY);  
}
...
#ifdef LORAWAN_ED_STACK_USING_ON_RTOS_RT_THREAD
    MacCtx.MacCallbacks->MacProcessNotify = loramac_process_notify;

    rt_event_init(&loramac_event, "ev_loramac", RT_IPC_FLAG_PRIO);//RT_IPC_FLAG_FIFO);

    rt_err_t result = RT_EOK;
    rt_thread_init(&loramac_thread,               	  
                   "loramac",                     	  
                   loramac_thread_entry,          	  
                   RT_NULL,                    	  
                   &rt_loramac_thread_stack[0],       
                   sizeof(rt_loramac_thread_stack),  
                   1,   // highest priority                       	  
                   20);                           
      
    if( result == RT_NULL )
    {
        rt_thread_startup(&loramac_thread);  
        
        LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"Initialize LoRaWAN MAC layer Done.\r");
    }
    else
    {
        LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"loramac_thread init failed.\r");
    }  
#else   
...
LoRaMacStatus_t LoRaMacMlmeRequest( MlmeReq_t* mlmeRequest )
{
    ...
    LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_MAC, DBG_LVL,"[UP-%s]: %s",loramac_mlme_req_strings[mlmeRequest->Type], loramac_status_strings[status]);
    return status;
}
