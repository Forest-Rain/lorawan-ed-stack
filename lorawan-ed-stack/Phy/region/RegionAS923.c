...
#define LOG_TAG             "LoRaWAN.PHY.AS923"
...
void RegionAS923InitDefaults( InitDefaultsParams_t* params )
{
    ...
    switch( params->Type )
    {
        case INIT_TYPE_INIT:
        {
            ...
            LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_PHY_REGION, DBG_LVL, "AS923 Total Channel Nums: %d",16);
            ...
            LORAWAN_ED_DEBUG_LOG(LORAWAN_ED_STACK_DEBUG_PHY_REGION, DBG_LVL, "Default Channels Mask: %04X-%04X\r\n", NvmCtx.ChannelsDefaultMask[0]);
